...
{
    class DeferredToonLightingShader : GLSLShader
    {
        ...
        public DeferredToonLightingShader() : base("Deferred Toon Lighting")
        {
            VertexCode = Resources.ImageEffect_vert;
            FragmentCode = Resources.DeferredToonLighting_frag;
        ...
        public override void SetUniqueParameter(ShaderUniqueParameter param, bool global)
        {
            if (global)
            {
                ...
                SetParameter(loc_resolution, param.resolution.Inverse());
