...
{
    public class GlareShader : GLSLShader
    {
        ...
        public GlareShader() : base("Glare")
        {
            VertexCode = Resources.ImageEffect_vert;
            FragmentCode = Resources.Glare_frag;
            ...
            RegistShaderParam("samplerBlur6", TextureUnit.Texture6);
            RegistShaderParam("samplerBlur7", TextureUnit.Texture7);
            RegistShaderParam("samplerBlur8", TextureUnit.Texture8);
            RegistShaderParam("samplerBlur9", TextureUnit.Texture9);
