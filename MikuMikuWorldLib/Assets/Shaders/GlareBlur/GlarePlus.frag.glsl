...
vec4 gaussianblur(sampler2D src, vec2 uv, vec2 dir)
{
	...
	color += (texture(src, uv + dir2 * 1.0) + texture(src, uv - dir2 * 1.0)) * 0.93;
	color += (texture(src, uv + dir2 * 2.0) + texture(src, uv - dir2 * 2.0)) * 0.8;
	color += (texture(src, uv + dir2 * 3.0) + texture(src, uv - dir2 * 3.0)) * 0.7;
	color += (texture(src, uv + dir2 * 4.0) + texture(src, uv - dir2 * 4.0)) * 0.6;
	color += (texture(src, uv + dir2 * 5.0) + texture(src, uv - dir2 * 5.0)) * 0.5;
	color += (texture(src, uv + dir2 * 6.0) + texture(src, uv - dir2 * 6.0)) * 0.4;
	color += (texture(src, uv + dir2 * 7.0) + texture(src, uv - dir2 * 7.0)) * 0.3;
	color += (texture(src, uv + dir2 * 8.0) + texture(src, uv - dir2 * 8.0)) * 0.2;
	color += (texture(src, uv + dir2 * 9.0) + texture(src, uv - dir2 * 9.0)) * 0.1;
